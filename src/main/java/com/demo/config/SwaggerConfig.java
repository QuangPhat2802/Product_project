...
public class SwaggerConfig {
	...
	public OpenAPI swaggerAPI() {
		...
		return new OpenAPI().info(apiInfo())
				.schemaRequirement("jwtToken",
						new SecurityScheme().name(tokenHeader).description("Json Web Token")
	...
	private Info apiInfo() {
		return new Info().title("product application API").description("Document API")
